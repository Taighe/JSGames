...
Brain.TimeSelection.prototype = 
{
	create: function() 
	{
		...
		var size = 200
		var fiveMin = new Brain.AddButton("", 0, game.height * 0.55, five, this, "5min", size, size, 0.5, 0.5, 1);	
		var tenMin = new Brain.AddButton("", fiveMin.right, game.height * 0.55, ten, this, "10min", size, size, 0.5, 0.5, 1);
		tenMin.left = fiveMin.right + 65;	
		var twentyMin = new Brain.AddButton("", tenMin.right, game.height * 0.55, twenty, this, "20min", size, size, 0.5, 0.5, 1);	
