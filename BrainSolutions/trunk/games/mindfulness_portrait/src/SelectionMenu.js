...
{    
    ...
    var spacing = 120
    this.button = new Brain.AddButton("", game.width * 0.2, SelectionMenu.items.total * spacing, click, this, "playButton", 60, 60, 0.5, 0, 15);
    this.titleSprite = Brain.AddText(title, this.button.right + 10, SelectionMenu.items.total * spacing, Color.white, 28, 0, 0, "normal", 800, "LatoRegular");
    this.titleSprite.events = this.button.button.events;
    this.subSprite = Brain.AddText(subtitle, this.button.right + 10, this.titleSprite.centerY + 10, Color.lightGray, 22, 0, 0, "normal", 800, "LatoRegular");
