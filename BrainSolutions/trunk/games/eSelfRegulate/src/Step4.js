...
Brain.Step4.prototype = 
{
	init: function(feeling, sprite, frame, negative, rating)
	{
	...
	create: function() 
	{
		...
		this.index = 0
		var game = Brain.game;
		this.wordArray = ["Remember a past event that made you feel this way.", "Can you notice your breathing or heart rate change?", "Now imagine a new outcome to make you feel calm.", "Click the button below when you feel a calm boost.", ]
		var fontSize = 25
		if(game.device.iOS)
		{
			fontSize = 20
		...
		this.go = new GenericButton("I FEEL CALMER", game.width * 0.5, game.height * 0.8, this.Next, this, 300, 70);
	...
	{
		var game = Brain.game;
		this.rating.negTime = this.timer;
		game.state.start("Step1", true, false, this.negative, this.rating);
	}
};