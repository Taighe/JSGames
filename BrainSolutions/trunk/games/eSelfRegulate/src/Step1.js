...
Brain.Step1 = function() 
{
	...
	this.happyArray = ["happy_child", "happy_outdoor", "happy_family", "happy_win"];
};

Brain.Step1.prototype = 
{
	init: function(feeling, rating)
	{
		...
		this.feelingSheet = this.happyArray[GetRandomInt(0, this.happyArray.length)]
	},
	create: function() 
	{
		...
		this.title = Brain.AddText("Choose the picture that makes you most HAPPY.", Brain.centerX, game.height * 0.1, Color.black, fontSize, 0.5, 0.5, "bold", 700, "LatoRegular");
	...
	{
		var game = Brain.game;
		game.state.start("Step2", true, false, this.feeling, this.feelingSheet, this.currentFrame, this.rating);
	}
};