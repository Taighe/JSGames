...
Brain.Preloader.prototype = 
{
	Start: function() 
	{
		...
		this.game.load.audio("s_in", "assets/audio/BreatheIn.mp3");
		this.game.load.audio("s_out", "assets/audio/BreatheOut.mp3");
		...
		this.game.load.image("icon", "assets/HeaderBeat.png");
		this.game.load.image("lungs", "assets/lungs.png");
		this.game.load.image("body", "assets/body.png");
		this.game.load.image("mask", "assets/lungs_small_mask.png");
		this.game.load.image("fill", "assets/lungs_blue_fill.png");
	...
	StartGame: function()
	{
		...
		var instructions = ["Training Your Calm Reflexes is like training a muscle\n-the more you do it-the bigger the benifit!"];
